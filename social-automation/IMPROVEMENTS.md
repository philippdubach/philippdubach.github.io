...
The workspace uses Node 24.19.0, exact Wrangler 4.123.0, one committed lockfile, Workers observability, Workers-runtime Queue/KV/DO tests, and dry-run packaging for all five Workers.
