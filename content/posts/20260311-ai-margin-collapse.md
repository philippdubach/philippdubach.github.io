...
keywords = ["AI model commoditization", "AI commoditization", "open-source AI models", "open source AI vs proprietary", "AI inference cost decline", "OpenAI valuation", "AI pricing war", "AI margins", "AI margin compression", "Qwen 3.5", "LLM switching costs", "AI model pricing", "disruptive innovation AI", "model layer commodity", "AI investment analysis", "inference cost"]
...
{{< img src="ai-performance-vs-price.png" alt="Exhibit showing open-source AI models have crossed the performance threshold at a fraction of the price, with GLM-5, Kimi K2.5, DeepSeek V3, and Qwen 3.5 Flash all landing in the high-performance low-cost quadrant below $1 per million tokens while Claude Opus 4.5 sits at $15 and GPT-4o at $2.50" width="80%" >}}

## What the steel mills can tell us

In the mid-1960s, electric arc furnace mini-mills entered the steel market at the lowest-quality segment: rebar. Capital costs ran one-fifth to one-seventh of what an integrated plant required. Nucor, the most aggressive operator, built its first mill for $6 million when a comparable integrated facility cost $500 million or more. The response from companies like U.S. Steel was rational: retreat from low-margin rebar, harvest the better-margin products, improve average profitability in the short term. Sensible. Wrong.
...
## The cost decline that makes strategy irrelevant
...
{{< img src="inference-cost-collapse.png" alt="Exhibit showing GPT-4 level performance went from $30 to $0.10 per million tokens in three years, with closed proprietary models shown alongside open-source alternatives that now match frontier performance at a fraction of the cost, representing a 300x cost reduction" width="80%" >}}
...
Enterprise behavior already reflects this. Perplexity's own data shows 92 percent of Fortune 500 employees use multi-model AI platforms, and their top enterprise accounts access an average of 30 different models. These are Perplexity's internal figures, not independent market research: treat them as directional. But the direction matches what I see in my own advisory work. Procurement teams now run model comparisons in an afternoon and rotate between Claude, Gemini, DeepSeek, and Qwen within a single sprint cycle. When that is the switching cost, pricing power is fiction sustained only by inertia.

The one meaningful source of lock-in is custom fine-tuned models, which are provider-specific and cannot be directly ported. That affects a small fraction of deployments. For the vast majority of inference calls, the model is interchangeable, and the customer buys on price.
...
{{< img src="openai-margin-squeeze.png" alt="Exhibit showing OpenAI financials: $20B ARR up 233% but gross margin fell from 40% to 33% as inference costs quadrupled to $8.4B, net loss of $13.5B in H1 2025, with the $840B valuation requiring 43% revenue CAGR to 2030 while expanding margins against open-source price pressure" width="80%" >}}

{{< readnext slug="the-690-billion-ai-capex-arms-race-who-blinks-first" >}}
...
I'm more confident in the framework than in the specific conclusions. The commoditization mechanics are clear. The timeline is not, and AI may have durable premium use cases that steel simply lacked. But when Nucor's managers were first eating U.S. Steel's rebar margins in 1967, the integrated mills' strategists probably reached a similar conclusion: yes, the pattern applies, but the premium market is safe. It wasn't. The performance gap that protected the premium market in steel measured in decades. In AI, it measured in twelve months.
