...
draft: false
images:
- https://static.philippdubach.com/ograph/ograph-aisceptics.jpg
...
- AI reasoning models limitations
- do AI models actually reason
- LLM reasoning collapse
- AI reasoning evaluation methodology
external_url: https://ml-site.cdn-apple.com/papers/the-illusion-of-thinking.pdf
categories:
- AI
type: Commentary
aliases:
- /2025/06/12/not-all-ai-skeptics-think-alike/

faq:
- question: 'What did Apple''s "Illusion of Thinking" paper find about AI reasoning?'
  answer: 'Apple''s paper identified three distinct performance regimes for AI reasoning models: standard models outperform reasoning models on simple problems, reasoning models show their advantage at medium complexity, and all models collapse completely at high complexity. The paper also found that reasoning models counterintuitively reduce their thinking effort as problems approach the collapse threshold, even when they have token budget remaining.'
- question: Why do AI reasoning models collapse at high complexity?
  answer: According to the research, reasoning models initially increase their thinking tokens proportionally with problem complexity but then begin reducing their reasoning effort near a critical threshold. Even when given explicit solution algorithms, performance did not improve, suggesting the collapse happens at roughly the same complexity threshold regardless of available guidance.
- question: Is the Tower of Hanoi a valid test of AI reasoning ability?
...
- question: Do AI reasoning models actually reason or just pattern match?
