...
description: SnitchBench tests whether AI models will autonomously report suspected
  illegal activities to authorities, revealing concerns about AI agency.
keywords:
- SnitchBench
- AI whistleblowing
- Claude Opus 4
