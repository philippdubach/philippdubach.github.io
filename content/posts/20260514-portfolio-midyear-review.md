...
draft = false
takeaways = [
  "Through May 29, the portfolio gained 5.2% in Swiss francs. A global 60/40 portfolio gained 5.4%, while the S&P 500 gained 9.0% in francs. The portfolio had fallen almost 4% during a late-March oil shock.",
  "Rates were the clean miss. I expected two or three Federal Reserve cuts and got none. The oil shock pushed US inflation towards 4%, while the bond holdings were flat to slightly negative in francs.",
  "Three rotation calls worked: Emerging Markets gained 20.7%, US Small Cap 13.2%, and Japan 13.1%. Europe gained 4.8%, behind US large-cap at 9.9%. Korean and Taiwanese chipmakers, not the Chinese technology companies I expected, drove the emerging-market result.",
  "I made three small changes rather than reversing the strategy. Gold rose from 5% to 6%, while crypto fell from 4.5% to 3.5%. I moved the Japan holding into a Swiss-franc-hedged share class after the yen reduced most of its local gain.",
]
faq = [
  {question = "How did the 2026 portfolio perform at midyear?", answer = "Through May 29, the portfolio returned 5.2% in Swiss francs on a time-weighted basis. This method removes the effect of deposits and withdrawals. A global portfolio with 60% equities and 40% bonds returned 5.4%. The S&P 500 total return was 9.0% in francs. The portfolio also had a drawdown of almost 4% in late March. A drawdown measures a fall from a previous peak."},
  {question = "Which 2026 thesis calls worked and which did not?", answer = "Three rotation calls worked through May 29 in Swiss francs. Emerging Markets gained 20.7%, US Small Cap 13.2%, and Japan 13.1%. Europe gained only 4.8%, behind US large-cap at 9.9%. The rate call missed because the Federal Reserve did not cut. Bond holdings were flat to slightly negative. Korean and Taiwanese chipmakers, rather than the expected Chinese technology companies, drove the emerging-market result."},
  {question = "Was the S&P 500 overvalued in May 2026?", answer = "By the Shiller cyclically adjusted price-to-earnings ratio (CAPE), yes. CAPE compares prices with ten years of inflation-adjusted earnings. It rose from 39.8 in December to about 42.7 in late May 2026. The December 1999 dot-com peak was 44.2, and the long-run mean was about 17.3. The ten largest companies represented 39.1% of the index. Nvidia alone represented 8.17%, up from 7.2% in December."},
  {question = "Did the Federal Reserve cut rates in 2026?", answer = "No. Through late May, the Federal Reserve had held rates at every meeting. A February-March oil shock pushed US inflation back towards 4%. My December thesis assumed two or three cuts. By spring, markets expected the European Central Bank to move before the Federal Reserve."},
  {question = "Should a Swiss investor hedge foreign-currency exposure?", answer = "It depends on the interest-rate difference between the two currencies. Hedging removes the effect of exchange-rate moves. With both Swiss and Japanese rates low, hedging the yen cost almost nothing. It also removed a drag that had erased most of Japan's local-currency gain. Hedging the dollar cost roughly 4% because US rates were higher. I kept the US Treasury holding unhedged and retained that interest advantage."},
  {question = "What changed in the portfolio at midyear?", answer = "Gold rose from 5% to 6%, funded with new cash. It remained the portfolio's only genuine diversifier. Crypto drifted from 4.5% to 3.5% after falling 19% with equities instead of protecting against the decline. I switched the Japan holding into a Swiss-franc-hedged share class. I also moved two individual stocks into the diversified exchange-traded funds that covered their market segments."},
]
+++
...
{{< img src="portfolio_performance_2026h1.png" alt="From January 2 to May 29, the portfolio gained 5.2% in francs, global 60/40 gained 5.4%, and S&P 500 gained 9.0%. The March trough was near -4%." width="80%" >}}
...
{{< img src="thesis_scorecard_2026h1.png" alt="Returns through May 29: emerging markets 20.7%, small caps 13.2%, Japan 13.1%, US large caps 9.9%, and Europe 4.8%. Gold gained 1.0%; corporate bonds 0.2%; global bonds were flat; euro bonds -0.1%; Treasuries -1.3%; listed private equity -13.5%; Bitcoin -19.3%." width="80%" >}}
...
Germany announced a €500 billion infrastructure fund, €400 billion for defence, and €600 billion in private commitments. [Citi's European equity team maintained its overweight view](https://www.citigroup.com/global/insights/european-equity-strategy-european-fiscal-stimulus-revisited). An overweight position exceeds the market's share in a benchmark. Citi projected 13% compound annual growth in German earnings per share through 2029.
...
{{< img src="cape_ratio_2026h1.png" alt="S&P 500 CAPE, 1990 to May 2026: 42.7 in May, 39.8 in December 2025, 17.3 long-run mean, and 44.2 dot-com peak" width="80%" >}}

Neither path closed the gap. The [CAPE was about **42.7**](https://www.multpl.com/shiller-pe) in late May, up from 39.8 at the end of December. No reading since December 1999 had been closer to the dot-com peak of 44.2. The valuation rose while earnings kept pace, and the rest of the world remained cheaper.
...
{{< img src="sp500_concentration_2026h1.png" alt="S&P 500 weights: Nvidia 8.17%, up from 7.2%; Apple 6.70%; Microsoft 4.96%, down from 5.9%; ten largest companies 39.1%" width="80%" >}}
...
{{< img src="regional_pe_2026h1.png" alt="May 2026 trailing price-to-earnings ratios: US 28, Japan 19, emerging markets 19, and Europe 18, a 35% discount to the US" width="80%" >}}

Two quarters of strong US earnings supported the high valuation. [FactSet reported a record 13.4% net profit margin for the first quarter of 2026](https://insight.factset.com/sp-500-earnings-season-update-may-1-2026). The index therefore looked expensive without looking fragile.

[JPM's Lakos-Bujas raised his year-end S&P 500 target to 7,600 in April](https://www.cnbc.com/2026/04/21/jpmorgan-raises-sp-500-target-as-mythos-model-bolsters-ai-trade.html). He raised expected 2026 earnings per share (EPS) to $330, a 22% annual increase. [Morgan Stanley's Mike Wilson set a 7,800 target](https://www.cnbc.com/video/2026/04/14/sp500-lows-are-in-for-the-year-for-the-sp-500-says-morgan-stanley-cio-mike-wilson.html) and called the market "early cycle." [Bank of America's Subramanian was more cautious at 7,100](https://www.cnbc.com/2025/12/15/bofas-savita-subramanian-says-sp-500-will-rise-to-just-7100-in-2026.html).
...
Gold behaved like a diversifier when it mattered. It held its value during the energy-shock drawdown while equities fell. Central banks also continued buying gold. [They bought 244 tonnes in the first quarter, according to the World Gold Council](https://www.gold.org/goldhub/research/gold-demand-trends/gold-demand-trends-q1-2026/central-banks).
...
{{< img src="allocation_decisions_2026h1.png" alt="Changes across 14 holdings: gold rose from 5% to 6%, crypto fell from 4.5% to 3.5%, and Japan stayed at 3% with a franc hedge" width="80%" >}}
