...
date = 2026-03-02
lastmod = 2026-03-02
publishDate = 2026-03-02T03:00:00Z
images = ["https://static.philippdubach.com/ograph/ograph-physics-department1.jpg"]
...
keywords = ["AI scientific discovery", "AI for science", "GPT-5.2 gluon discovery", "Peter Thiel stagnation thesis", "AI compute gap science", "Great Stagnation AI", "AI breakthrough physics 2026", "total factor productivity decline", "AlphaFold Nobel Prize 2024", "federal AI R&D spending", "AI fusion energy plasma control", "dual-use AI technology", "DeepMind GNoME materials discovery", "AI drug discovery clinical trials", "scattering amplitudes theoretical physics", "research productivity decline", "computational irreducibility physics", "bits vs atoms innovation", "AI accelerated physics", "scientific progress stagnation"]
draft = false
categories = ["AI"]
type = "Article"
takeaways = [
...
faq = [
  ...
  {question = "How much does Big Tech spend on AI compared to the US government?", answer = "The ratio is roughly 75:1. Big Tech spent over $250 billion on AI infrastructure in 2024-2025. Total US federal AI R&D is $3.3 billion per year. The DOE Genesis Mission's $320 million first round is less than Meta spends on AI infrastructure in a single week."},
...
On December 11, [Jimmy Carr](https://en.wikipedia.org/wiki/Jimmy_Carr) sat on the [TRIGGERnometry podcast](https://www.youtube.com/watch?v=mWDCZIvLrS4) and delivered a riff that sounded like Peter Thiel's stagnation thesis filtered through a comedian's timing: 
...
The data supports the velocity claim. Total factor productivity growth, the metric that captures genuine scientific progress and technological improvement, ran at roughly 1.7% annually from 1947 to 1973. Since 2004, it has averaged 0.4%. Robert Gordon's *The Rise and Fall of American Growth* argues the "special century" of 1870 to 1970 was a one-time event. [Bloom, Jones, Van Reenen, and Webb](https://mattsclancy.substack.com/p/science-is-getting-harder) showed in the *American Economic Review* that maintaining Moore's Law required 18x more researchers in 2014 versus 1971.
