...
draft = false
takeaways = [
  "By May 2026, eight of Aschenbrenner's most concrete dated technology and infrastructure predictions have confirmed cleanly (test-time compute, GPQA saturation, power as binding constraint, gas-for-AI, Gulf chip pivot, AMD compute TAM); eight political-economy predictions have falsified (voluntary lab merger, Congressional trillions, coalition of democracies, DPA invocation, export controls tightening).",
  "The methodological choice that produced both halves of the record is what Aschenbrenner calls 'the modal story' — refusing probability distributions in favour of a vivid, dated narrative bet. The method is durable on empirically-lawful substrates and brittle on coalition-political ones.",
  "His three intellectual identities — libertarian, Burkean hawk, alignment optimist — run as a series circuit: each premises the next. Drop any one and the synthesis collapses. Mixed evidence on a multiplicative chain is closer to disconfirmation than the headline scorecard suggests.",
  "Situational Awareness LP — anchored by Patrick Collison, John Collison, Daniel Gross, and Nat Friedman — is the framework expressed in capital. The semis and power trades worked; the bond short on real interest rates above 10% has not fired and is the cleanest test of whether the syllogism's last link survives 2027.",
]
faq = [
  {question = "Did Leopold Aschenbrenner's Situational Awareness predictions come true?", answer = "Partially. By May 2026, eight of his dated technology and infrastructure predictions have confirmed (test-time compute, GPQA Diamond saturation, power as the binding constraint, Marcellus gas-for-AI, the Gulf chip pivot, AMD's compute TAM). Eight political-economy predictions have falsified (voluntary lab merger, Congressional trillions, a coalition of democracies, DPA invocation, tightening export controls). The technology and infrastructure record is roughly 8-of-10 confirmed; the political-economy record is roughly 8-of-10 falsified."},
  {question = "Is AGI by 2027 still on track per Situational Awareness?", answer = "Aschenbrenner's window remains open but contested. Test-time compute paradigm shifts validated his framework in a register he did not himself emphasise. Pretraining scaling has slowed relative to RL post-training in ways that complicate the additive 5-OOM framing. Capability gains continued; whether the threshold he calls 'drop-in remote worker' is reached by 2027 is the open question his own LP is positioned around."},
  {question = "What is the Burkean Accelerationist worldview?", answer = "Aschenbrenner combines three positions normally held separately: a libertarian presumption against state action, a Burkean reverence for two-hundred-year-old institutions, and an empirical optimism about alignment tractability. The synthesis runs as a series circuit — each identity premises the next. He invokes Burke specifically to argue that AGI is a national-security-decisive technology that the existing constitutional architecture must absorb, which yields a Promethean prescription (a peacetime industrial nationalisation) defended on Burkean grounds."},
  {question = "Why was Leopold Aschenbrenner fired from OpenAI?", answer = "Aschenbrenner was a member of OpenAI's Superalignment team and was dismissed in May 2024, one to two weeks before his colleagues Ilya Sutskever and Jan Leike resigned. The stated reasons in his exit interview included a security memo he sent to the board, his refusal to sign the November 2023 employee letter supporting Sam Altman's reinstatement, and his views on AGI nationalisation. He refused the company's non-disparagement NDA, walking from approximately one million dollars in vested equity. Within five weeks the Superalignment team was dissolved."},
  {question = "What is Situational Awareness LP and who anchors it?", answer = "Situational Awareness LP is the San Francisco investment firm Aschenbrenner co-founded in mid-2024, anchored by Patrick Collison, John Collison, Daniel Gross, and Nat Friedman. The fund expresses the Situational Awareness framework in capital: long semiconductors, power utilities, behind-the-meter gas, and AGI-adjacent infrastructure; the famous 'big bond short' on real interest rates above 10% has not fired."},
  {question = "What is the modal-story method of forecasting?", answer = "Aschenbrenner refuses probability distributions and instead 'tells the modal story' — a vivid, dated, falsifiable narrative bet on what the decade looks like. The method's strength is that it is gradable: it produces dated claims that can be scored against reality. Its limitation is substrate-sensitivity: the method is durable on processes governed by empirical lawfulness (log-log scaling curves, capex aggregates, hyperscaler power draw) and brittle on processes governed by elections, executive turnover, and coalition politics."},
]
+++
...
The alignment researcher: he was an initial member of OpenAI's Superalignment team, fired in April 2024 for sharing a security memo with the board. He refused the non-disparagement NDA and walked from roughly a million dollars in equity. *"Freedom is priceless,"* was his summary. He thinks the default plan — scalable oversight, weak-to-strong generalisation, interpretability — will probably work. By the standards of MIRI and Yudkowsky, he is an optimist.
...
**Power as the binding constraint.** This was the most prescient single line of policy-relevant analysis in the essay, preceding [Wood Mackenzie's headline numbers](https://www.woodmac.com/press-releases/gas-turbine-prices-soar-195-as-market-faces-supply-demand-crisis/) by roughly six months. Heavy-frame turbine lead times now run six years, with OEM order books sold through 2027. [S&P Global put data-centre grid power at +22% in 2025](https://www.spglobal.com/energy/en/news-research/latest-news/electric-power/101425-data-center-grid-power-demand-to-rise-22-in-2025-nearly-triple-by-2030). The power-not-chips framing he laid out before consensus is now industry consensus.

**Marcellus shale and behind-the-meter gas.** He argued the only way to power the trillion-dollar cluster was abundant US natural gas, contra hyperscaler climate pledges. Meta has since [ordered ten gas plants for the Hyperion build](https://www.bloomberg.com/news/articles/2026-04-29/meta-s-need-for-gas-power-boosts-entergy-spending-by-14-billion) (7.5 GW, +30% to Louisiana's grid). [Microsoft and Chevron and Engine No. 1 are partnered](https://www.bloomberg.com/news/articles/2026-03-31/microsoft-in-talks-with-chevron-engine-no-1-over-7-billion-texas-power-plant) on 5 GW in West Texas. [Williams Companies committed $5B to behind-the-meter turbines](https://www.power-eng.com/gas/williams-pushes-deeper-into-power-generation-as-data-center-demand-accelerates/). There are now over 250 GW of new gas capacity in the US pipeline.
...
[Stargate UAE](https://openai.com/index/introducing-stargate-uae/) is now under construction at 5 GW eventual capacity (200 MW Q3 2026). [HUMAIN deployed its first 18,000 GB300s in Saudi Arabia](https://nvidianews.nvidia.com/news/humain-and-nvidia-announce-strategic-partnership-to-build-ai-factories-of-the-future-in-saudi-arabia). [The Trump administration authorised 70,000 GB300s to G42 and HUMAIN in November 2025](https://www.bloomberg.com/news/articles/2025-11-19/us-reaches-ai-chip-sale-agreement-with-g42-in-win-for-uae-firm). The thing he warned against happened, and *it was authorised by the same US government he expected to nationalise the labs*.

**AMD's compute TAM.** He cited AMD's $400B AI accelerator forecast for 2027. AMD has since reaffirmed and [upgraded to a $1T compute TAM by 2030](https://www.amd.com/en/newsroom/press-releases/2025-11-11-amd-unveils-strategy-to-lead-the-1-trillion-compu.html).
...
Walking from a million dollars in equity to publish his views is not nothing. The alignment-research literature is better off because *Situational Awareness* exists. The diagnostic instinct was sharp; the institutional optimism was naïve. The project is honourable; the optimism is wrong.
...
Situational Awareness LP, anchored by Patrick Collison, John Collison, Daniel Gross, and Nat Friedman, is the artefact that makes the worldview unavoidable. Aschenbrenner is one of the few public intellectuals on AI who has put his own capital, and his anchor investors' capital, where his framework points. The trade sequence he laid out in the Dwarkesh interview — NVIDIA first, then TSMC and packaging and memory, then US power and utilities, then natural gas, then Google later, then "the big bond short" on real interest rates above 10%, then OTM tail bets — is the framework expressed in capital. Each trade is a falsifiable claim. The capital position is what he believes net of his hedges.
...
*Sources: Leopold Aschenbrenner, "Situational Awareness: The Decade Ahead" (June 2024); Dwarkesh Patel podcast, "Leopold Aschenbrenner — 2027 AGI, China/US Super-Intelligence Race, & The Path To AGI" (June 2024). Prediction scoring drawn from publicly available May 2026 data on hyperscaler capex, NVIDIA earnings, METR time horizons, GPQA Diamond benchmarks, Anthropic and Apollo alignment research, and Trump administration AI executive orders. Anchor investor disclosures: Aschenbrenner publicly named Patrick Collison, John Collison, Daniel Gross, and Nat Friedman as anchor investors in Situational Awareness LP. The author of this essay holds no position in any company referenced.*
