...
faq = [
  {question = "How should I rebalance my portfolio for 2026?", answer = "Consider reducing US large-cap exposure (S&P 500 at 23× forward P/E), increasing European equities (22% discount to global peers with Germany's €1T+ infrastructure commitment), adding fixed income (10-year UST at 4.2%), and maintaining currency hedges against expected dollar depreciation."},
  {question = "Why are S&P 500 valuations concerning for 2026?", answer = "The S&P 500's Shiller CAPE ratio sits at 40.5, more than double its historical mean of 17.3. Top 10 companies represent 45% of the index, a concentration level not seen since the dot-com bubble. Small-cap and international equities offer more attractive entry points."},
  {question = "Is the US dollar expected to depreciate in 2026?", answer = "JP Morgan estimates the dollar remains roughly 10% overvalued, with Goldman Sachs projecting 4% depreciation. The key drivers are America's shrinking share of global trade and persistent fiscal deficits. Dollar weakness supports gold and currency-hedged international exposure."},
  {question = "Why invest in European equities in 2026?", answer = "Germany's historic €1 trillion+ infrastructure commitment represents a structural break from fiscal conservatism. European equities trade at a 22% discount to global peers. JP Morgan upgrades eurozone growth to 1.5%, and the US-Europe growth differential is expected to narrow from 60bps to 30bps."},
]
+++
