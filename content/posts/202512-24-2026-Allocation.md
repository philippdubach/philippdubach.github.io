...
date = 2025-12-12
images = ["https://static.philippdubach.com/ograph/ograph-2026portfolio.jpg"]
...
keywords = ["2026 portfolio allocation strategy", "S&P 500 concentration risk 2026", "dollar depreciation investment hedge", "Germany infrastructure investment 2026", "fixed income allocation 2026"]
categories = ["Investing"]
type = "Essay"
draft = false
aliases = ["/2025/12/12/how-ai-is-shaping-my-investment-portfolio-for-2026/"]
takeaways = [
...
faq = [
  {question = "What does the S&P 500's valuation look like heading into 2026?", answer = "The S&P 500's Shiller CAPE ratio sits at 40.5 as of early December 2025, more than double its historical mean of 17.3. The top 10 companies represent approximately 45% of the index, a concentration level not seen since the dot-com bubble."},
  {question = "What is the consensus view on the US dollar heading into 2026?", answer = "Per published outlooks, JP Morgan estimates the dollar remains roughly 10% overvalued, with Goldman Sachs projecting 4% depreciation over the coming year. The drivers cited are America's shrinking share of global trade and persistent fiscal deficits."},
  {question = "What is the case for European equities in 2026?", answer = "Germany's historic €1 trillion+ infrastructure commitment represents a structural break from fiscal conservatism. European equities trade at a 22% discount to global peers per the cited research. JP Morgan upgrades eurozone growth to 1.5%, and the US-Europe growth differential is expected to narrow from 60bps to 30bps."},
]
+++

This essay describes how I am thinking about my own personal long-term portfolio heading into 2026. It is a journal of how I structured my own allocation given the macro context — not a recommendation for any reader to take any action. I separately run a satellite book of short-term option plays and individual stocks; this essay does not cover that. The essay is structured along five themes I currently weigh:
...
By way of summary, here is how my own personal allocation looks heading into 2026:
...
What moved and why, in my own book: US Equities (-10%): S&P 500 valuations at 23× forward P/E look full to me; the Nasdaq's 30× trailing P/E reflects continued optimism. I moved my own large-cap exposure from 33% to 23% to reduce concentration risk around the combination of equity multiples and USD direction. I redeployed roughly 5% into US small-cap exposure, where valuation dispersion has been wider. Europe (+5%): European equities trade at a 22% discount to global peers per the cited research and Germany's €1T+ infrastructure commitment has structurally changed my own view of the region. I moved my own European weight from 8% to 13%. Fixed Income (+4%): Global yields remain near post-GFC highs with 10-year UST around 4.2% in December 2025. I shifted from 10% to 14% in fixed income personally (with CHF Corporates, EUR Govt Bonds and US Treasuries the personal vehicles), establishing duration ahead of expected Fed cuts. Japan (Unchanged): Japan's structural reforms and BOJ stimulus remain supportive but I held my own 3% Asia Developed exposure. Asia EM (+0.5%): I moved from 10% to 10.5% in my own book to maintain exposure to Chinese stimulus and Asia tech multiples. Alternatives (+0.5%): I moved my own Listed PE/Alt sleeve from 1.5% to 2%. Gold (+1%): I moved my own gold from 4% to 5% as a hedge against USD direction. Crypto (+0.5%): I moved my own digital-asset sleeve from 4% to 4.5%. None of the above is an instruction for any reader; readers should consult their own advisers about their own circumstances. At the <a href="#end">end of this article</a>, I have included a short, more technical insight into how I structured my research process.
...
In my own book, I modestly increased my FX-hedged gold position from 4.0% to 5.0%. Gold's performance through December 2025 (up roughly 58% year-to-date) makes any further increase a momentum bet rather than a value one.
