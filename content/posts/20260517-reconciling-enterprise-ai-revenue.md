...
takeaways = [
  "Four widely cited 2025 AI revenue figures span 40x: $37B from Menlo, a $100-135B vendor run-rate sum, $307B from IDC, and $1.478T from Gartner. Each is correct within its stated perimeter. Definitions, not measurement error, explain the reconciliation.",
  "Revenue supported by filings and executive dollar disclosures totals $63.2B after strict overlap adjustments. A broader treatment adds hardware integration and CoreWeave's external revenue, giving $72.5B. These figures form the defensible audit-grade floor for $690B of 2026 hyperscaler capital expenditure. Looser figures combine channel markup, third-party annual recurring revenue claims, or full-retail device value in one denominator.",
  "The narrow audit-grade basis implies a 10.9x capital-expenditure-to-revenue ratio. The 1990s telecom peak was 3.5x. Even AI-incremental capital expenditure gives 6.3-7.9x, worse than the closest historical analogue.",
  "The Spread Index divides audit-grade revenue by Gartner's umbrella figure. It opened at 4.28% narrow and 4.90% broad in May 2026. If it remains below 5% through the fourth quarter of 2026, disclosure alone cannot improve capital expenditure coverage. Revenue must compound."
]
faq = [
...
Menlo Ventures put US enterprise generative AI spending at [$37B for 2025](https://menlovc.com/perspective/2025-the-state-of-generative-ai-in-the-enterprise/) in its December 2025 report. A run-rate annualizes the most recent revenue pace. A bottom-up sum of disclosed vendor run-rates gives $100-135B worldwide. IDC sized the 2025 [AI Solutions](https://www.idc.com/getdoc.jsp?containerId=prUS53413925) market at $307B. Gartner [forecast](https://www.gartner.com/en/newsroom/press-releases/2025-09-17-gartner-forecasts-worldwide-genai-spending-to-reach-1-point-5-trillion-in-2025) $1.478T of total worldwide AI spending for 2025.
...
The [IDC Worldwide AI Spending Guide](https://www.idc.com/getdoc.jsp?containerId=IDC_P33198) estimates worldwide AI Solutions spending from vendor-share data and channel surveys. IDC includes hardware, services, and software when it tracks them as bundled enterprise AI solutions. It excludes consumer-device hardware. The single figure mixes vendor-recognized revenue with buyer spending.

### Gartner: $1.478T

Gartner's [September 17, 2025 release](https://www.gartner.com/en/newsroom/press-releases/2025-09-17-gartner-forecasts-worldwide-genai-spending-to-reach-1-point-5-trillion-in-2025) divides worldwide AI spending into five categories. They are AI-enabled devices ($389B), AI services ($283B), AI-optimized servers ($268B), AI software ($298B), and "other" ($242B). Gartner counts the full retail value of any product sold with an AI feature. Gartner analyst John Lovelock [said](https://www.networkworld.com/article/4058786/gartner-ai-spending-to-reach-1-5-trillion-dollars-this-year.html) buyers receive the device layer with the product and do not specifically select it.
...
{{< img src="reconciling-ai-revenue-nested-circles-1.png" alt="Concentric circles compare five 2025 AI revenue measures, from Menlo's $37B estimate to Gartner's $1.478T estimate. Different scopes produce the 40-fold spread." width="80%" >}}
...
Below Tier B, the evidence changes. The $123B midpoint includes Tier C-F sources and private-vendor ARR claims. At the May 2026 cutoff, these included OpenAI's $25B, according to [Sacra](https://sacra.com/c/openai/). Anthropic added $19B based on [remarks by its chief executive at Morgan Stanley's technology, media, and telecommunications conference](https://finance.yahoo.com/news/anthropic-arr-surges-19-billion-151028403.html). Cursor added $2B, and DeepSeek's estimate added $1.1B. A reader who accepts nothing below Tier B gets the $63.2B narrow audit-grade figure.
...
{{< img src="reconciling-ai-revenue-waterfall-1.png" alt="Waterfall chart reconciles Gartner's $1.478T estimate with Menlo's $37B estimate. Four deductions remove broader products, channel markup, weaker disclosures, and non-US revenue." width="80%" >}}
...
The [vendor census](https://static.philippdubach.com/pdf/reconciling-enterprise-ai-revenue-2025.pdf) finds four Tier A disclosures among 68 vendors. NVIDIA's [Data Center segment](https://investor.nvidia.com/financial-info/financial-reports/default.aspx) reported $62.3B in the fourth quarter of fiscal year 2026, or \~$249B annualized. AMD's [Data Center segment](https://ir.amd.com/financial-information/financial-results) reported $5.8B in the first quarter of 2026, or \~$23B annualized. Broadcom's [AI semiconductor disclosure](https://investors.broadcom.com/financial-information/quarterly-results) was $8.4B in the first quarter of fiscal year 2026, or \~$34B annualized. [CoreWeave](https://investors.coreweave.com/financial-information/sec-filings) has been publicly listed since March 2025. It reported \~$5.1B of fiscal-year 2025 revenue. CoreWeave says all its revenue comes from AI infrastructure.
...
The 1990s telecom buildout peaked at roughly [28% capex coverage](/posts/ai-capex-arms-race-who-blinks-first/). Its inverse was 3.5x capex-to-revenue. It is the closest analogue and the one [Pozsar-era infrastructure bears](/posts/pozsars-bretton-woods-iii-the-framework-1/2/) cite. The May 2026 narrow coverage ratio was roughly one-third of that peak. Even the reconciled midpoint gave worse coverage than telecom in 1999.

{{< img src="reconciling-ai-revenue-capex-coverage-1.png" alt="Chart compares capital-expenditure coverage: 28 percent for 1990s telecom versus 9.2 percent for AI in 2026. AI's capex-to-revenue ratio is 10.9x, versus telecom's 3.5x." width="80%" >}}
