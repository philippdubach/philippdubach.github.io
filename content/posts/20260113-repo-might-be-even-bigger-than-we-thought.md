...
seoTitle = "The $12.6 Trillion Repo Market: New OFR Data and Shadow Banking"
keywords = ["repo market", "shadow banking", "Standing Repo Facility", "money market liquidity", "Zoltan Pozsar"]
...
That's [Zoltan Pozsar](https://en.wikipedia.org/wiki/Zoltan_Pozsar), the Hungarian-American economist who mapped the plumbing of modern money before most people knew there was plumbing to map. When he said it to Bloomberg in 2019, he was trying to explain why repo markets _([the overnight lending infrastructure that lubricates trillions in daily transactions](https://en.wikipedia.org/wiki/Repurchase_agreement))_ had just seized up in ways the Federal Reserve didn't anticipate.

I've [written about Pozsar's work before](https://philippdubach.com/posts/pozsars-bretton-woods-iii-the-framework-1/2/), particularly his "Bretton Woods III" thesis about the shifting role of the dollar. But his earlier research on shadow banking and repo markets feels increasingly relevant as we enter 2026. In December 2025, the Office of Financial Research [published new data](https://www.financialresearch.gov/the-ofr-blog/2025/12/04/sizing-us-repo-market/) on the size of the U.S. repo market. The number: $12.6 trillion in average daily exposures. That's roughly $700 billion larger than previous estimates; a measurement error roughly the size of the entire Swiss banking system.
