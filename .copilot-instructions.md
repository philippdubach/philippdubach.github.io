...
- `layouts/categories/` - Category taxonomy templates
- `layouts/types/` - Content type taxonomy templates
...
- Use `categories:` for topics (Finance, AI, Medicine, Tech, Economics) - 1-2 per post
- Use `type:` for content type (Project, Commentary, Essay, Review) - exactly 1 per post
- Use `tags: ["Project"]` for project posts (backward compat with projects page)
